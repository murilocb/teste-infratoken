...
The directions are saved as logs in MongoDB.

For example: If user x applies a direction xyz, xyz goes into a backlog through the created MongoDB.

## Installation

```bash
git clone https://github.com/murilocb/teste-infratoken.git
cd teste-infratoken
```
